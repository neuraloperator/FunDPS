...
For generation, download the pre-trained model weights from [[1]](https://zenodo.org/records/18562619) or [[2]](https://drive.google.com/drive/folders/1mBnSX69f2xwUs9KA37fA_eqbOg0o8AbU?usp=sharing) and update the `.pkl` paths in the corresponding config files under `configs/generation/`.
